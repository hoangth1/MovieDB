...
class SearchResultAdapter(private val onItemClick: (MovieItem) -> Unit,
                          val onFavoriteClick: (MovieItem) -> Unit) : BaseRecyclerViewAdapter<MovieItem>(
    ...
    override fun handleChildClick(viewDataBinding: ViewDataBinding) {
        if (viewDataBinding is ItemSearchResultBinding) {
